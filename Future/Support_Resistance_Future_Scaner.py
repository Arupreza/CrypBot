...
class LiquidationSafeFuturesTrader:
    ...
    def trade(self, coin, margin_amount, leverage=5, side='long', take_profit_ratio=2.0, 
              ...
              swing_lookback=10, liquidation_buffer=5, auto_monitor=True):
    ...
    def get_all_positions(self):
        ...
        try:
            ...
            if not active_positions:
                ...
                monitoring_count = sum(1 for pos in active_positions if pos['monitoring_active'])
                logger.info(f"🔍 Positions being monitored: {monitoring_count}/{len(active_positions)}")
...
# 1. Test the fixed JUP short trade (this should now work!)
# futures_trader.trade("JUP", 10, leverage=20, side="short", liquidation_buffer=5)

# 2. Conservative BTC long trade
# futures_trader.trade("BTC", 100, leverage=10, side="long", liquidation_buffer=5)

# 3. ETH short with fixed take profit
# futures_trader.trade("ETH", 50, leverage=5, side="short", use_fixed_tp=True, fixed_tp_percent=3.0)

# 4. Trade with swing levels
# futures_trader.trade("SOL", 25, leverage=8, side="long", use_swing_levels=True, swing_lookback=15)

# 5. Check balance
# futures_trader.get_balance()

# 6. Check all positions
# futures_trader.get_all_positions()

# 7. Close a position manually
# futures_trader.close_position("BTC", reason="MANUAL_EXIT")

# logger.info("🚀 Enhanced Liquidation-Safe Futures Trader Ready!")
# logger.info("✨ Key Features:")
# logger.info("   🛡️ FIXED liquidation price calculation for both long and short positions")
# logger.info("   📊 Real-time position monitoring")
# logger.info("   🔍 Automatic take profit and stop loss execution")
# logger.info("   📈 Enhanced safety buffers and validation")
# logger.info("   🛡️ Minimum 5% liquidation safety buffer")
# logger.info("")
# logger.info("🎯 Your JUP short trade should now work correctly!")
# logger.info("Try: futures_trader.trade('JUP', 10, leverage=20, side='short', liquidation_buffer=5)")