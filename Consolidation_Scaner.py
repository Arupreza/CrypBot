...
class CryptoLongTradeScanner:
    ...
    def generate_long_signal(self, symbol: str) -> str:
        ...
        if stats_24h:
            ...
            output += f"├─ 24h High: ${stats_24h['high_24h']:.8f}\n"
            output += f"├─ 24h Low: ${stats_24h['low_24h']:.8f}\n"
        ...
        if is_consolidating:
            ...
            output += f"├─ Live Price: ${live_price:.8f}\n"
            output += f"├─ Resistance: ${metrics['resistance']:.8f}\n"
            output += f"├─ Support: ${metrics['support']:.8f}\n"
            output += f"└─ Wait for breakout above ${metrics['resistance']:.8f}\n\n"
            ...
            output += f"├─ Price broke resistance: ${metrics['resistance']:.8f}\n"
            output += f"├─ Live Price: ${live_price:.8f}\n"
            ...
            output += f"├─ Price above resistance: ${live_price:.8f}\n"
            output += f"├─ Resistance level: ${metrics['resistance']:.8f}\n"
            output += f"└─ Consider entry with stop at ${metrics['resistance']:.8f}\n\n"
            ...
            output += f"├─ Live Price: ${live_price:.8f}\n"
            output += f"├─ Trend MA: ${breakout_conditions['ma_value']:.8f}\n"
        ...
        if signal_strength > 0:
            ...
            output += f"├─ Entry: ${live_price:.8f}\n"
            output += f"├─ Stop Loss: ${stop_loss:.8f} (-{risk:.2f}%)\n"
            output += f"├─ TP1 (50%): ${take_profit_1:.8f} (+1.0%)\n"
            output += f"├─ TP2 (50%): ${take_profit_2:.8f} (+2.0%)\n"
